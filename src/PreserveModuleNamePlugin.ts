...
function isNodeModule(module: Webpack.NormalModule) {
 ...
 */
function getNodeModuleData(module: Webpack.NormalModule): NodeModule.Data | null {
  // Not a node_module?
 ...
 *  @return {undefined}
 */
function mapNodeModule(module: Webpack.NormalModule) {
  // Not a node_module?
  if (!isNodeModule(module)) {
    return;
  }
 ...
 */
function getRelativeModule(module: Webpack.NormalModule, paths: string[]): string | null {
 ...
 */
function getAliasModule(module: Webpack.NormalModule, aliases: { [key: string]: string | false | string[] } | null): string | null {
 ...
 */
function getModuleId(module: Webpack.NormalModule, paths: string[], aliases: { [key: string]: string | false | string[] } | null): string {
